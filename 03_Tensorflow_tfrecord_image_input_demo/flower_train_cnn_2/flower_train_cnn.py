...
def flower_eval():
    ...
    with tf.Session() as sess:
        ...
        for i in range(15):
            ...
            accuracy_out, logits_batch_out, labels_batch_out = sess.run([accuracy, logits_max, labels_max], feed_dict={image_batch_placeholder: image_out,
                                                                                                                       label_batch_placeholder: label_batch_one_hot_out,
                                                                                                                       keep_prob: 1})
            ...
            print("label_out: ")
            print(filename_out)
            print(labels_batch_out)
            print(logits_batch_out)

        print("Accuracy: %f" % (accuracy_accu / 15.0))

...
tf.app.flags.DEFINE_string('train_directory', './data_train_3570',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', './data_eval_100',
...
def _process_image_files_batch(coder, thread_index, ranges, name, filenames,
  ...
  #print('---> [thread_index: %d] num_shards = %d' % (thread_index, num_shards))
  #print('---> [thread_index: %d] num_threads = %d' % (thread_index, num_threads))
  #print('---> [thread_index: %d] num_shards_per_batch = %d' % (thread_index, num_shards_per_batch))

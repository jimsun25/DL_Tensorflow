...
batches = []
print("%d items in batch of %d gives us %d full batches and 1 batch of %d items" % (
    len(inputs),
    batch_size,
...
first_input, first_label = batches[0]
last_input , lsat_label  = batches[-1]
print("Size of full batch: %d" % len(first_input))
print("Size if final batch: %d" % len(last_input))
